# Generated by Powerlevel10k configuration wizard on 2021-06-18 at 22:28 IST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 25238.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, slanted separators, slanted heads, sharp tails, 2 lines, dotted, no frame,
...
() {
  ...
  # Colors for CPU Temperature
  typeset -g POWERLEVEL9K_MY_CPU_TEMP_FOREGROUND=208
  ...
  ################[ todo: todo items (https://github.com/todotxt/todo.txt-cli) ]################
  # Todo color.
  typeset -g POWERLEVEL9K_TODO_FOREGROUND=118
  typeset -g POWERLEVEL9K_TODO_BACKGROUND=6
